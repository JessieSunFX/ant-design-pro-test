...
Inspector.prototype.registerUpdateEvent = function (nodeCategory, data, itemName, element) {
    ...
    function updateNode() {
        self.updateNodeProperties(nodeCategory, data, itemName, element);
    }

    element.addEventListener("change", updateNode);
}

Inspector.prototype.ShowStartComponentPanel = function (inspectedObject) {
    ...
    tr1.textContent = "开始组件，目前没有可配置属性";
...
Inspector.prototype.ShowIntentComponentPanel = function (inspectedObject) {
...
Inspector.prototype.ShowKeyComponentPanel = function (inspectedObject) {
    var mainDiv = this._div;
    mainDiv.innerHTML = '';
...
Inspector.prototype.ShowConditionComponentPanel = function (inspectedObject) {
    var mainDiv = this._div;
    mainDiv.innerHTML = '';
...
Inspector.prototype.ShowInterfaceComponentPanel = function (inspectedObject) {
    var mainDiv = this._div;
    mainDiv.innerHTML = '';
...
Inspector.prototype.ShowTransferManualServiceComponentPanel = function (inspectedObject) {
    var mainDiv = this._div;
    mainDiv.innerHTML = '';
...
Inspector.prototype.ShowInfoCollectionComponentPanel = function (inspectedObject) {
    var mainDiv = this._div;
    mainDiv.innerHTML = '';
...
Inspector.prototype.ShowEndComponentPanel = function (inspectedObject) {
    var mainDiv = this._div;
    mainDiv.innerHTML = '';
    ...
    var tr1 = document.createElement("tr");
    tr1.textContent = "结束组件，目前没有可配置属性";
    tbody.appendChild(tr1);
    table.appendChild(tbody);
    mainDiv.appendChild(table);
...
Inspector.prototype.updateNodeProperties = function (nodeCategory, data, itemName, element) {
    ...
    if (data.category === 'StartComponent') {
        ...
        this.updateIntentNodeData(data, itemName, element);
    } else if (data.category === 'KeyComponent') {
        this.updateKeyNodeData(data, itemName, element);
    } else if (data.category === 'ConditionComponent') {
        this.updateConditionNodeData(data, itemName, element);
    } else if (data.category === 'InterfaceComponent') {
        this.updateInterfaceNodeData(data, itemName, element);
    } else if (data.category === 'TransferManualServiceComponent') {
        this.updateTransferManualServiceNodeData(data, itemName, element);
    } else if (data.category === 'InfoCollectionComponent') {
        this.updateInfoCollectionNodeData(data, itemName, element);
    } else {

    }
};

Inspector.prototype.updateIntentNodeData = function (data, itemName, element) {
...
Inspector.prototype.updateKeyNodeData = function (data, itemName, element) {
    var diagram = this._diagram;
...
Inspector.prototype.updateConditionNodeData = function (data, itemName, element) {
    var diagram = this._diagram;
...
Inspector.prototype.updateInterfaceNodeData = function (data, itemName, element) {
    var diagram = this._diagram;
...
Inspector.prototype.updateTransferManualServiceNodeData = function (data, itemName, element) {
    var diagram = this._diagram;
...
Inspector.prototype.updateInfoCollectionNodeData = function (data, itemName, element) {
    var diagram = this._diagram;
...
Inspector.prototype.buildPropertyRow = function (propertyName, propertyValue) {
    ...
    if (decProp && decProp.type === "select") {
        ...
        if (input.type !== "color") input.addEventListener("blur", function () {
            alert(this);
        });
    }
